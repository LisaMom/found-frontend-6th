import { useAddNewProductMutation, useDeleteProductByUUIDMutation, useUpdateProductByUUIDMutation } from "../../services/ecommerceApi";
...
const createProduct = {
  ...
  "description": "Compact 14-inch gaming laptop with AMD Ryzen 9 processor, ideal for gaming and content creation on the go.",
  "computerSpec": {
  ...
  "color": [
    ...
    },
    {
      ...
      "images": [
        "https://example.com/images/rog-g14-white-1.jpg"
      ]
    }
  ],
  "thumbnail": "https://dlcdnwebimgs.asus.com/gain/08000E15-8711-44FD-9B43-067CAC3F3A78",
...
const updateProduct = {
  ...
  "description": "Compact 14-inch gaming laptop with AMD Ryzen 9 processor, now with upgraded RAM and storage for 2026.",
  "stockQuantity": 12,
  "priceIn": 1250,
  "priceOut": 1650,
  "discount": 15,
...
async function updateProductFunc(){
    updateProductRequest({
      ...
      uuid: "bb300b3f-f75e-41d8-a32e-17c892715869"
    })
  }
  ...
  return (
   <div className="flex gap-2">
    {/* button create product */}
      <button className="border p-4 rounded bg-green-500 text-white"
      onClick={() => createProductFunc()}>Create Product</button>
      {/* button update product by uuid */}
      <button className="border p-4 rounded bg-yellow-500 text-white"
      onClick={() => updateProductFunc()}>Update Product</button>
      {/* button delete product by uuid */}
      <button className="border p-4 rounded bg-red-500 text-white"
      onClick={() => deleteProductFunc()}>Delete Product</button>
    </div>
  )
}